...
export default function Airport() {
  ...
  const internationalCount = airportData.filter(
    (airport) => airport.intnl
  ).length;
  ...
  return (
    <main className="my-6 ">
      ...
      <section className="max-w-[450px] sm:max-w-screen-xl">
        <div className="bg-white rounded-lg border border-gray-200 shadow-sm mb-6 overflow-x-scroll">
          <TableComponent
            columns={columns}
            data={airportData}
