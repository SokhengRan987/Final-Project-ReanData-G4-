...
import SlidBarComponent from "../components/SlidBarComponent"
      ...
      <main className="overflow-hidden">
            ...
            >
              <div className="relative flex h-full items-center justify-center bg-gray-400 dark:bg-gray-700 dark:text-white">
                ...
                <div className="absolute inset-0 flex flex-col justify-center items-start px-8 md:px-20 lg:px-36">
                  ...
                  >
                    A platform designed to help beginners explore data analysis, <br className="hidden md:block" />
                    management, and visualization in an interactive and user-friendly way.
                  </motion.span>
                </div>
              </div>
              <div className="relative flex h-full items-center justify-center bg-gray-400 dark:bg-gray-700 dark:text-white">
                ...
                <div className="absolute inset-0 flex flex-col justify-center items-start px-8 md:px-20 lg:px-36">
                  ...
                  <motion.span
                    ...
                    className="text-white text-lg md:text-xl"
                  >
                    To make data analytics accessible for everyone by providing an <br className="hidden md:block" />
                    interactive platform for hands-on learning, visualization, and real-world data exploration.
                  </motion.span>
                </div>
              </div>
              <div className="relative flex h-full items-center justify-center bg-gray-400 dark:bg-gray-700 dark:text-white">
                ...
                <div className="absolute inset-0 flex flex-col justify-center items-start px-8 md:px-20 lg:px-36">
                  ...
                  <motion.span
                    ...
                    className="text-white text-lg md:text-xl"
                  >
                    To provide beginner-friendly tools, real-world datasets, and <br className="hidden md:block" />
                    interactive visualizations that help users develop essential data skills and make informed decisions
                  </motion.span>
                </div>
              </div>
            </Carousel>
        ...
        <section className="lg:px-36 sm:px-10 md:px-10 px-5 py-16 bg-gradient-to-b from-white to-gray-50">
          <motion.div
            ...
            className="mt-8"
          >
            <span className="text-red-600 font-bold text-2xl block">ABOUT US</span>
            <span className="text-blue-800 font-bold text-4xl md:text-5xl lg:text-6xl">REAN DATA?</span>
          </motion.div>
          ...
          <div className="grid grid-cols-12 gap-8 mt-16">
            ...
            >
              ...
              <div className="mb-8 bg-white p-6 rounded-[20px] shadow-sm hover:shadow-md  transition-shadow duration-300">
                ...
                <p className="text-base sm:text-lg md:text-xl text-gray-700 tracking-wide mb-4 pl-14">
                  We are a team of data enthusiasts dedicated to making data analytics accessible to everyone. Our
                  platform bridges the gap between complex data science and everyday users, providing intuitive tools
                  that transform raw data into meaningful insights. With a focus on education and practical application,
                  we empower users to make data-driven decisions with confidence.
                </p>
              </div>
                ...
                <div className="space-y-6">
                  <div className="space-y-4 bg-blue-50 p-5 rounded-lg">
                    ...
                    <p className="text-base sm:text-lg md:text-xl text-gray-700 pl-10">
                      To become the go-to platform for beginners in data analytics, making data exploration simple,
                      insightful, and practical for real-world applications.
                    </p>
                  </div>
                  ...
                  <div className="space-y-4 bg-red-50 p-5 rounded-lg">
                    ...
                    <p className="text-base sm:text-lg md:text-xl text-gray-700 pl-10">
                      To provide beginner-friendly tools, real-world datasets, and interactive visualizations that help
                      users develop essential data skills and make informed decisions.
                    </p>
                  </div>
                </div>
              </div>
            ...
            >
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm mt-16">
                <h3 className="text-2xl font-bold text-blue-800 mb-4">Our Approach</h3>
...
<section className="py-16 bg-gradient-to-b from-white to-gray-50">
  <div className="lg:px-36 sm:px-10 md:px-10 px-5">
    ...
    >
      <span className="text-blue-600 font-bold text-xl inline-block mb-2">OUR MENTORS</span>
      <h2 className="text-red-700 font-bold text-4xl md:text-5xl">Learn From The Best</h2>
      <div className="w-24 h-1 bg-red-600 mx-auto mt-4"></div>
      <p className="text-gray-700 max-w-2xl mx-auto mt-6 text-lg">
        Our mentors are industry leaders who provide guidance, share expertise, and help our users develop their data skills.
      </p>
    </motion.div>
      ...
      {[
        {
          ...
          quote: "My goal is to demystify data science and make it accessible to everyone."
        },
        {
          name: "Jennifer Lee",
          ...
          quote: "Empowering the next generation of innovators through practical AI knowledge."
        }
      ].map((mentor, index) => (
        <motion.div
          key={index}
        ...
        <section className="py-16 bg-gradient-to-b from-gray-50 to-white">
          <div className="lg:px-36 sm:px-10 md:px-10 px-5">
            <motion.div
              ...
              className="text-center mb-16"
            >
              <span className="text-red-600 font-bold text-xl inline-block mb-2">OUR EXPERTS</span>
              <h2 className="text-blue-800 font-bold text-4xl md:text-5xl">Meet Our Team</h2>
              <div className="w-24 h-1 bg-blue-600 mx-auto mt-4"></div>
              <p className="text-gray-700 max-w-2xl mx-auto mt-6 text-lg">
                Our diverse team of data experts brings together years of experience in data science, analytics, and
                education to create the best learning experience for you.
              </p>
            </motion.div>
