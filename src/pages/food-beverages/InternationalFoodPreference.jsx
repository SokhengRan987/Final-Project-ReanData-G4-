...
import StackedBarChart from "../../components/foodAndBeverages/internationalFoodPreference/StackedBarChart";

export default function InternationalFoodPreference() {
  useEffect(() => {
    AOS.init({
