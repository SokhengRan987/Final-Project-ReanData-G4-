...
import PieChartDiningLocation from "../../components/foodAndBeverages/preferredDiningLocation/PieChartDinningLocation";

export default function PreferredDiningLocation() {
  useEffect(() => {
    AOS.init({
      ...
      <div className="max-w-screen-xl mx-auto">
        ...
        >
          <div className="w-full" data-aos="zoom-in" data-aos-delay="75">
            <PieChartDiningLocation />
          </div>
        </section>

        {/* Storytelling Section */}
        <section className="mt-8 overflow-visible">
          <div className="border-2 border-blue-100 rounded-[20px] p-6 bg-blue-50">
