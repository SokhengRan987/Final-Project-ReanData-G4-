...
export default function Line() {
        ...
        animation: {
          ...
          onProgress: (animation) => {
            ...
            const currentDataValue =
              firstValue + (lastValue - firstValue) * currentProgress;
            ...
            const currentChangePercent = (
              ((currentDataValue - firstValue) / firstValue) *
              100
            ).toFixed(1);
  ...
  //       setTimeout(() => {
  //         chartInstance.current.data.datasets[0].pointRadius = chartInstance.current.data.datasets[0].pointRadius.map(() => 4);
  //         chartInstance.current.update();
  //       }, 300);
  //     };
  ...
  return (
    <div className="main-container w-full max-w-screen-xl h-auto bg-gradient-to-br relative mx-auto my-8 lg:px-8">
      ...
      <div className="flex w-full max-w-screen-xl h-[490px] sm:h-[550px] pt-4 pr-4 sm:pr-8 pb-4 sm:pb-8 pl-4 sm:pl-8 flex-col gap-4 justify-center items-center flex-nowrap bg-white rounded-lg relative mt-4 sm:mt-6 mx-auto transition-all duration-500 border border-[#3C55A5]">
        <div className="flex flex-col sm:flex-row gap-2 items-center self-stretch shrink-0 flex-nowrap relative">
          ...
          <div className="relative">
            <div
              className="flex px-4 py-2 gap-1 items-center shrink-0 flex-nowrap bg-gray-100 rounded-lg relative z-[10] hover:shadow-sm transition-all duration-300 cursor-pointer"
            ...
            {isDropdownOpen && (
              <div className="absolute right-0 mt-1 bg-white rounded-lg shadow-lg z-10 overflow-hidden transition-all duration-300 animate-fadeIn">
                <ul className="py-1">
        ...
        <div className="grid grid-cols-1 sm:gap-6 items-start self-stretch grow shrink-0 basis-0 flex-nowrap relative">
          ...
          <div className="flex justify-between items-center self-stretch shrink-0 flex-nowrap relative z-10">
            <div className="flex gap-2 items-center shrink-0 flex-nowrap relative z-[51]">
              <span
                className={`shrink-0 basis-auto font-['Roboto'] text-lg font-bold leading-5 tracking-[-0.16px] relative text-left whitespace-nowrap z-10 transition-all duration-1000 ${
              ...
              <div className="flex gap-1 items-end shrink-0 flex-nowrap relative z-[53]">
                <span
                  className={`flex justify-center items-start shrink-0 basis-auto font-['Roboto'] text-xs font-semibold leading-4 relative text-center whitespace-nowrap z-[54] transition-all duration-1000 ${
                ...
                <svg
                  ...
                  className={`transition-transform duration-500 ${
                    isPositive ? "transform-none" : "rotate-180"
                  }`}
                >
                  <path
                    d="M8 4L13 9H3L8 4Z"
            ...
            <div className="flex gap-1 justify-center items-center shrink-0 flex-nowrap relative z-[56] bg-[#f8f9fa] px-3 py-1 rounded-full transition-all hover:cursor-pointer duration-300 hover:bg-[#e9ecef] cursor-poRoboto group">
      ...
      <div className="w-full max-w-screen-xl font-['Roboto'] text-[18px] sm:text-[20px] md:text-[24px] font-normal leading-6 sm:leading-8 relative text-left mt-4 sm:mt-6 mx-auto p-1 transition-all duration-500">
        ...
        <span className="font-['Roboto'] text-[16px] sm:text-[18px] md:text-[20px] leading-6 sm:leading-8 text-[#334155] relative text-left block mt-3 sm:mt-4 mb-4 sm:mb-6">
          A line chart is a type of graph that represents data points connected
          by a line, showing trends and changes over time. It is commonly used
        ...
        <ul className="mt-3 sm:mt-4 space-y-2 mb-4 sm:mb-6">
          <li className="flex items-start">
            ...
            <span className="ml-2 sm:ml-3 text-sm sm:text-base md:text-lg text-[#334155] mb-2">
              Time Series Data – This is one of the most common uses for line
              charts, such as(Example:Monthly sales figures)
            </span>
          </li>
          <li className="flex items-start">
            <div className="flex-shrink-0 h-6 w-6 rounded-full bg-[rgba(60,85,165,0.15)] flex items-center justify-center mt-1">
            ...
            <span className="ml-2 sm:ml-3 text-sm sm:text-base md:text-lg text-[#334155] mb-2">
              Trends and Patterns– Data that shows a gradual increase, decrease,
          ...
          <li className="flex items-start">
            ...
            <span className="ml-2 sm:ml-3 text-sm sm:text-base md:text-lg text-[#334155] mb-2">
              Comparisons Over Time – Line charts can display multiple datasets
              on the same graph to compare their trends over the same period.
            </span>
          </li>
        </ul>
        <span className="font-['Roboto'] text-[18px] sm:text-[20px] md:text-[24px] leading-8 sm:leading-10 text-[#1e293b] relative text-left block before:content-[''] before:absolute before:w-8 sm:before:w-10 before:h-1 before:bg-[#3C55A5] before:bottom-[-4px] before:left-0 before:rounded-full">
        ...
        <ul className="mt-6 space-y-2">
          <li className="flex items-start">
            ...
            <span className="ml-2 sm:ml-3 text-sm sm:text-base md:text-lg text-[#334155] mb-2">
              Clarity of Trends – Line charts clearly show how data changes over
              time, making it easy to identify trends (e.g., increasing or
              decreasing patterns)
            </span>
          </li>
          <li className="flex items-start">
            ...
            <span className="ml-2 sm:ml-3 text-sm sm:text-base md:text-lg text-[#334155] mb-2">
              Comparing Multiple Data Sets – With multiple lines on the same
              chart, you can easily compare trends between different data sets,
              such as comparing sales for two products or performance across
              different regions.
            </span>
          </li>
          <li className="flex items-start">
            ...
            <span className="ml-2 sm:ml-3 text-sm sm:text-base md:text-lg text-[#334155] mb-2">
              Predictive Insights – By showing the historical trend, line charts
              can be used to make forecasts about future data points, helping in
