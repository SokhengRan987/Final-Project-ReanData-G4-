...
export default function ScatterPlot() {
      ...
      datasets: [
        {
          ...
          pointBackgroundColor:
            sixMonthsData.datasets[0].pointBackgroundColor.slice(3),
        },
      ],
    };
            ...
            callbacks: {
              ...
              label: function (context) {
                return [
                  ...
                  "ROI: " +
                    ((context.parsed.y / context.parsed.x - 1) * 100).toFixed(
                      1
                    ) +
                    "%",
                ];
  ...
  useEffect(() => {
    if (selectedPoint !== null && chartInstance.current && isLoaded) {
      ...
      const originalPointRadius = Array(chartData.datasets[0].data.length).fill(
        8
      );
  ...
  return (
    <div className="main-container w-full max-w-screen-xl h-auto bg-gradient-to-br relative mx-auto my-8 lg:px-8">
      ...
      <div className="flex w-full max-w-screen-xl h-[460px] sm:h-[550px] pt-4 sm:pt-6 pr-4 sm:pr-8 pb-4 sm:pb-8 pl-4 sm:pl-8 flex-col gap-4 justify-center items-center flex-nowrap bg-white rounded-lg relative mt-4 sm:mt-6 mx-auto transition-all duration-500 border border-[#3C55A5]">
        <div className="flex flex-col sm:flex-row gap-2 items-center self-stretch shrink-0 flex-nowrap relative mt-0 sm:mt-0">
          ...
          <div className="relative">
            <div
              className="flex px-4 py-2 gap-1 items-center shrink-0 flex-nowrap bg-gray-100 rounded-lg relative z-[4] hover:shadow-sm transition-all duration-300 cursor-pointer"
        ...
        <div className="grid grid-cols-1 sm:gap-6 items-start self-stretch grow shrink-0 basis-0 flex-nowrap relative">
          <div className="self-stretch h-72 sm:h-96 grow shrink-0 basis-0 rounded-lg relative border hover:shadow-sm overflow-hidden transition-all duration-500">
            {/* Chart.js Canvas */}
            <canvas ref={chartRef} className="w-[400px] sm:w-full h-full"></canvas>
          </div>
          <div className="flex flex-col sm:flex-row justify-between items-center self-stretch shrink-0 flex-nowrap relative">
            <div className="flex flex-col gap-1 items-start shrink-0 flex-nowrap relative">
              <span className="font-['Roboto'] text-xs sm:text-lg font-bold text-[#343a40]">
                {pointInfo}
              </span>
            </div>
            <div className="flex gap-2 hover:cursor-pointer justify-center items-center shrink-0 flex-nowrap relative">
      ...
      1. What is a Scatter Plot?
        ...
        <span className="font-['Roboto'] text-[16px] sm:text-[18px] md:text-[20px] leading-6 sm:leading-8 text-[#334155] relative text-left block mt-3 sm:mt-4 mb-4 sm:mb-6">
          A scatter plot is a type of graph that shows the relationship between
          two numerical variables by plotting individual data points on an X-Y
          coordinate system.
        </span>
        <span className="font-['Roboto'] text-[18px] sm:text-[20px] md:text-[24px] leading-8 sm:leading-10 text-[#1e293b] relative text-left block before:content-[''] before:absolute before:w-8 sm:before:w-10 before:h-1 before:bg-[#3C55A5] before:bottom-[-4px] before:left-0 before:rounded-full">
        ...
        <ul className="mt-3 sm:mt-4 space-y-2 mb-4 sm:mb-6">
          <li className="flex items-start">
            ...
            <span className="ml-2 sm:ml-3 text-sm sm:text-base md:text-lg text-[#334155] mb-2">
              Height vs. Weight (e.g., comparing the height and weight of
              individuals)
            </span>
          </li>
          <li className="flex items-start">
            ...
            <span className="ml-2 sm:ml-3 text-sm sm:text-base md:text-lg text-[#334155] mb-2">
              Temperature vs. Ice Cream Sales (e.g., does warmer weather lead to
              higher sales?)
            </span>
          </li>
          <li className="flex items-start">
            ...
            <span className="ml-2 sm:ml-3 text-sm sm:text-base md:text-lg text-[#334155] mb-2">
              Study Time vs. Exam Scores (e.g., does studying more improve test
              performance?)
            </span>
          </li>
          <li className="flex items-start">
            ...
            <span className="ml-2 sm:ml-3 text-sm sm:text-base md:text-lg text-[#334155] mb-2">
              Advertising Spend vs. Revenue (e.g., does more marketing lead to
              higher sales?)
            </span>
          </li>
        </ul>
        ...
        <ul className="mt-6 space-y-2">
          <li className="flex items-start">
            ...
            <span className="ml-2 sm:ml-3 text-sm sm:text-base md:text-lg text-[#334155] mb-2">
              Identifying Relationships – Helps determine if two variables are
              positively correlated, negatively correlated, or have no
              relationship.
            </span>
          </li>
          <li className="flex items-start">
            ...
            <span className="ml-2 sm:ml-3 text-sm sm:text-base md:text-lg text-[#334155] mb-2">
              Detecting Trends and Patterns – Reveals linear or nonlinear trends
              (e.g., exponential growth, clusters).
            </span>
          </li>
          <li className="flex items-start">
            <div className="flex-shrink-0 h-6 w-6 rounded-full bg-[rgba(60,85,165,0.15)] flex items-center justify-center mt-1">
            ...
            <span className="ml-2 sm:ml-3 text-sm sm:text-base md:text-lg text-[#334155] mb-2">
              Spotting Outliers – Highlights data points that don’t fit the
              general pattern, which may indicate errors or special cases.
            </span>
          </li>
        </ul>
      </div>
